...
public class Main extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        lbStatus.setText("Server đang dừng");
    ...
    private void stopServer() throws Exception {
        int c = JOptionPane.showConfirmDialog(this, "Bạn có muốn dừng Server", "Dừng Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
        if (c == JOptionPane.YES_OPTION) {
            lbStatus.setForeground(new Color(255, 51, 51));
            txt.setText("Server đã dừng ...");
            run.interrupt();
            server.close();
        }
    }
    private void cmdStartActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdStartActionPerformed
        try {
            int c = JOptionPane.showConfirmDialog(this, "Khi chạy Server, tất cả những dữ liệu cũ sẽ bị xóa", "Chạy Server", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
            if (c == JOptionPane.YES_OPTION) {
                startServer();
            }
        } catch (Exception e) {
