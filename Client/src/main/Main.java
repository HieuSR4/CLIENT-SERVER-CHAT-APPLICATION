...
public class Main extends javax.swing.JFrame {
    ...
    private void open() {
        ...
        Method.setTextFieldSyle(txt, "Nhập tin nhắn ở đây ...");
        for (int i = 0; i < 10; i++) {
    ...
    private void initComponents() {
        ...
        txt.setFont(new java.awt.Font("font", 0, 14)); // NOI18N
        ...
        jLabel1.setFont(new java.awt.Font("font", 1, 14)); // NOI18N
        jLabel1.setForeground(new java.awt.Color(102, 102, 102));
        jLabel1.setText("Danh sách bạn bè");

        jLabel2.setFont(new java.awt.Font("font", 1, 14)); // NOI18N
        ...
        cmdLogOut.setFont(new java.awt.Font("font", 1, 12)); // NOI18N
        ...
        lbStatus.setFont(new java.awt.Font("font", 0, 14)); // NOI18N
    ...
    private void cmdLogOutActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_cmdLogOutActionPerformed
        int c = JOptionPane.showConfirmDialog(this, "Bạn có muốn đăng xuất ?", "Đăng xuất", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE);
